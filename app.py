...
class CriminalDetectionSystem:
    def __init__(self):
        ...
        print("  Make sure recipient numbers are verified in Twilio Console!")
    ...
    def send_alert(self, weapon_type, confidence=0.0, footage_path=None):
        ...
        try:
            ...
            for phone in self.police_numbers:
                try:
                    ...
                    if "unverified" in error_str:
                        print("  PHONE NUMBER NOT VERIFIED! Verify in Twilio Console")
                        ...
                        print("  INVALID FROM NUMBER! Check Twilio phone number")
                    elif "invalid" in error_str and ("to" in error_str or "number" in error_str):
                        print(f"  INVALID TO NUMBER: {phone}")
            ...
            if "authenticate" in error_str or "invalid" in error_str:
                print("  AUTHENTICATION FAILED! Check your Twilio SID and Token")
            elif "account" in error_str:
                print(" ACCOUNT ISSUE! Check your Twilio account status")
